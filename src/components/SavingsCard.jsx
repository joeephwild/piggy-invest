...
const SavingsCard = () => {
  return (
    <div className="max-w-[423px] relative max-h-[200px] bg-gradient-to-r from-[#FFFFFF] to-[#DADEE8] shadow-md py-2.5 px-4.5">
      ...
      <div className="flex-col flex px-4 items-start space-y-8">
        ...
        <h2 className="font-bold text-[#000] text-[36px] leading-[44px]">$2000</h2>
        ...
        <div className="flex items-center space-x-3">
            ...
            <p className="bg-[#00C851] text-[#000] text-[16px] font-medium leading-[20px] px-2 py-2">+0.3%</p>
        </div>
