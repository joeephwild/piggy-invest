...
const OverallSavings = ({ title, value }) => {
  return (
    <div className="max-w-[46vw] relative max-h-[200px] bg-gradient-to-r from-[#FFFFFF] to-[#DADEE8] shadow-md py-3 px-4.5 rounded">
      ...
      <div className="flex justify-between">
        <div className="flex-col flex px-4 items-start space-y-8">
            <p className="font-bold text-[#FF7034] text-[16px] leading-[20px]">{title}</p>
            <h2 className="font-bold text-[#000] text-[31px] leading-[44px]">{value}</h2>
